...
<html lang="en">
	...
	<div id="newspaper">
		...
		<h3>This is the article's title<span class="article-type">Opinion</span></h3>
		...
		<div class="article-author">- The Reverend (06.01.26)</div>
	    </div>
	    
	    <div class="article small-article pad">
		<h3>This is the article's title<span class="article-type">Review</span></h3>
		<div class="article-text">
		    Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur
		</div>
		<div class="article-author">- Hoops McCann (06.01.26)</div>
	    </div>
	    
	    <div class="article pad">
		<h3>This is the article's title<span class="article-type">Current Affairs</span></h3>
		<div class="article-text">
		    Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?
		</div>
		<div class="article-author">- The Wrangler (06.01.26)</div>
	    </div>
