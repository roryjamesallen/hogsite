...
1. Clone the repository to your local machine (e.g. `git clone git@github.com:steve/stevesite.git`). If you want to test it locally then clone it into wherever you store that stuff e.g. `var/www/html/stevesite` for Linux or your XAMPP `htdocs/stevesite` directory if using that or a similar program/stack.
