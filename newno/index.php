...
<html lang="en">
  ...
  <hr>
  <h3>Challenges</h3>
  If a player does not shout 'UNO' when they are down to one card, or touch a hand that is being passed to them (for example if a 7 or 0 has been played) that only contains one card, they are liable to be challenged. Any other player can say 'challenge' if they spot that someone has not shouted UNO, and the challenged player must draw 2 cards. Play resumes as normal from whoever's turn it was before the challenge was made.<br><br>If a player incorrectly challenges another, <i>they</i> must draw 2 cards.<br><br>
  <hr>
  <h3>Penalty Cards</h3>
  <div class="drawing-by-text">
