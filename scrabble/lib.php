...
function renderCreateGameForm(){
    ...
    for ($players=2; $players<=8; $players++){
        ...
        echo '<label for="players-'.$players.'">'.$players.'</label><br>';
    }
    echo '<label for="nickname-input">Your Nickname<br></label><input id="nickname-input" maxlength="16" name="nickname"><br><input type="submit" value="Create Game"></form>';
}
?>
