...
<html lang='en'>
	...
	<div class="collapsible" id="me">
		...
		<h3>About</h3>
		<span>My name is Rory Allen, I am <span id="age">(loading)</span> old.
		    You can email me at <a href="mailto:rory@hogwild.uk">rory@hogwild.uk</a> -
		    I like to be emailed and aim to respond to every one that I get! </span>
	    </div>
	    <div class="collapsible">
		<h3>Currently Into</h3>
		<span>I have been using <a href="https://www.pi.fyi/">Perfectly Imperfect</a> when I feel like scrolling
		    (eventually maybe I won't even have the urge) and it's great, I find myself far more often clicking into something
		    and it inspiring me to do something worthwhile or research something rather than just encouraging people to stick on the feed</span>
	    </div>
		...
		<ul class="hide-numbers">
		    ...
		    <li class="collapsible"><h4>Bass</h4><span>I still don't think of myself as a bassist but I've played/play bass in
			<a href="https://otalaband.com">Otala</a> and <a href="https://www.instagram.com/foolbandofficial/">Fool</a>.
	...
	<div class="collapsible">
		...
		<li><h3>Oct 2019</h3>Start uni at <a href="https://en.wikipedia.org/wiki/Loughborough_University">Loughborough</a> (shithole!!! if anyone in sixth form tells you to "pick based on the course because that's what you're there for,
		    the city comes second", take it with a fat pinch of salt)</li>
